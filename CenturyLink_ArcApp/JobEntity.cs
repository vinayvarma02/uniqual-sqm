    ...
    public class JobEntity
    {
        ...
        public static JobEntity GetInstance()
        {
            if (EntityTable == null)
                ...
                {
                    //jobTable
                    jobTableName = "QUAL_SCHEMA.JOB_DETAILS",
                    jobId = "JOB_ID",
                    ...
                    //review table
                    ReviewTableName = "QUAL_SCHEMA.REVIEW_DETAILS",
                    ...
                    failureTablename = "QUAL_SCHEMA.JOB_FAILURES",
                    ...
                    //StatsTable
                    jobStats_Tablename = "QUAL_SCHEMA.JOB_STATISTICS_LOGS",
